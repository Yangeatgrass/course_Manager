/*
 ...
 Source Host           : rm-uf6y190evz40k9xtwoo.mysql.rds.aliyuncs.com:3306
 Source Schema         : couse_manager

 Target Server Type    : MySQL
 Target Server Version : 80025
 File Encoding         : 65001

 Date: 17/05/2023 11:26:00
*/
...
CREATE TABLE `course`  (
  ...
  `user_id` int(0) NULL DEFAULT NULL COMMENT '课程所属的教员id',
  ...
  `course_date` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程学期',
  `topic` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '选题',
  `course_content` blob NULL COMMENT '课题内容',
  `start_num` int(0) NULL DEFAULT NULL COMMENT '开课所需人数',
  `start_time` datetime(0) NULL DEFAULT NULL COMMENT '课程开始时间',
  `end_time` datetime(0) NULL DEFAULT NULL COMMENT '课程结束时间',
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '课程状态(0草稿1未开课2已开课3停用)',
  ...
  `del_flag` tinyint(1) NULL DEFAULT 0 COMMENT '删除标识(0存在1删除)',
...
CREATE TABLE `course_user`  (
  `cu_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `course_id` int(0) NULL DEFAULT NULL COMMENT '课程id',
  `student_id` int(0) NULL DEFAULT NULL COMMENT '学员id',
...
CREATE TABLE `group`  (
  ...
  `course_id` int(0) NULL DEFAULT NULL COMMENT '小组课程id',
  `group_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '小组名称',
  `group_manager` int(0) NULL DEFAULT -1 COMMENT '组长id（学员）',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `status` tinyint(1) NULL DEFAULT 0 COMMENT '状态（0正常1停用）',
  `group_content` blob NULL COMMENT '小组介绍',
  `create_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `del_flag` tinyint(1) NULL DEFAULT 0 COMMENT '删除标识（0存在1不存在）',
...
CREATE TABLE `group_user`  (
  `gu_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `group_id` int(0) NULL DEFAULT NULL COMMENT '小组id',
  `student_id` int(0) NULL DEFAULT NULL COMMENT '学员id',
  `is_manager` tinyint(1) NULL DEFAULT NULL COMMENT '是否组长（0是1否）',
  `join_time` datetime(0) NULL DEFAULT NULL COMMENT '加入时间',
  `invite` int(0) NULL DEFAULT NULL COMMENT '邀请人id',
...
-- ----------------------------
-- Table structure for public_user_assign
-- ----------------------------
DROP TABLE IF EXISTS `public_user_assign`;
CREATE TABLE `public_user_assign`  (
  `public_user_assign_id` int(0) NOT NULL AUTO_INCREMENT,
  `public_file_id` int(0) NULL DEFAULT NULL,
  `user_id` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`public_user_assign_id`) USING BTREE
...
-- ----------------------------
-- Table structure for resource_course_file
-- ----------------------------
DROP TABLE IF EXISTS `resource_course_file`;
CREATE TABLE `resource_course_file`  (
  `course_file_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '课题文件id',
  `course_id` int(0) NOT NULL COMMENT '课题id',
...
CREATE TABLE `resource_file`  (
  ...
  `file_nounit_size` double NULL DEFAULT NULL COMMENT '文件大小，无单位',
  `file_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '文件路径',
  `disk_path` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '磁盘路径',
  `download_count` int(0) NULL DEFAULT 0 COMMENT '下载次数',
  `is_folder` tinyint(1) NULL DEFAULT NULL COMMENT '是否为文件夹(0不是1是)',
  `parent_id` int(0) NULL DEFAULT -1 COMMENT '是否为父文件夹(默认-1,表示没有父文件夹)',
  `identifier` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT 'MD5唯一标识',
  `create_time` datetime(0) NULL DEFAULT NULL,
  `create_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `update_time` datetime(0) NULL DEFAULT NULL,
  `update_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `del_flag` tinyint(1) NULL DEFAULT 0 COMMENT '删除标识(0未删除,1删除)',
  `audit` tinyint(1) NULL DEFAULT 0 COMMENT '审核标识，一般只在学员上传时会修改为1，经过审核0，失败为2，默认为0',
  PRIMARY KEY (`file_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 378 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for resource_group_file
-- ----------------------------
DROP TABLE IF EXISTS `resource_group_file`;
CREATE TABLE `resource_group_file`  (
  `group_file_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `group_id` int(0) NULL DEFAULT NULL COMMENT '小组id',
  `file_id` int(0) NULL DEFAULT NULL COMMENT '文件id',
  `audit` tinyint(1) NULL DEFAULT NULL COMMENT '审核标识',
  `is_top` tinyint(1) NULL DEFAULT NULL COMMENT '置顶',
  PRIMARY KEY (`group_file_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 62 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for resource_person_file
-- ----------------------------
DROP TABLE IF EXISTS `resource_person_file`;
CREATE TABLE `resource_person_file`  (
  `person_file_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `student_id` int(0) NULL DEFAULT NULL COMMENT '学员id',
  `file_id` int(0) NULL DEFAULT NULL COMMENT '文件id',
  PRIMARY KEY (`person_file_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 59 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for resource_public_file
-- ----------------------------
DROP TABLE IF EXISTS `resource_public_file`;
CREATE TABLE `resource_public_file`  (
  `public_file_id` int(0) NOT NULL AUTO_INCREMENT,
  `file_id` int(0) NULL DEFAULT NULL,
  `visible` tinyint(0) NULL DEFAULT 0 COMMENT '文件权限（0全部可见，1需要权限）',
  PRIMARY KEY (`public_file_id`) USING BTREE
...
CREATE TABLE `student`  (
  `student_id` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `s_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学号',
  `student_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学生姓名',
  `grade` tinyint(1) NULL DEFAULT NULL COMMENT '年级(1,2,3,4)',
  `gender` tinyint(1) NULL DEFAULT NULL COMMENT '性别(0女，1男)',
  `birth` datetime(0) NULL DEFAULT NULL COMMENT '出生日期',
  `origin` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '籍贯',
  ...
  `political` tinyint(1) NOT NULL DEFAULT 0 COMMENT '政治面貌（0无，1共青团员，2党员）',
  `majors_studied` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所学专业',
  `professional` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '专业方向',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `del_flag` tinyint(1) NULL DEFAULT 0 COMMENT '删除标识(0存在1删除)',
  `flag` tinyint(1) NULL DEFAULT 0 COMMENT '学号是否可用',
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '状态(0可用，1不可用)',
...
CREATE TABLE `student_user`  (
  `su_id` int(0) NOT NULL AUTO_INCREMENT,
  `student_id` int(0) NULL DEFAULT NULL COMMENT '学员id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 33092 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时任务调度日志表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3805 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2086 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '通知公告表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3694 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 285 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `teacher`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '教员id',
  `id_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '证件号码',
  `teacher_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '教员姓名',
  `type` tinyint(0) NULL DEFAULT NULL COMMENT '人员类别',
  `gender` tinyint(1) NULL DEFAULT NULL COMMENT '性别(0男，1女，2未知)',
  `birth` datetime(0) NULL DEFAULT NULL COMMENT '出生日期',
  `nation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '民族',
  `origin` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '籍贯',
  ...
  `biography` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '个人简介',
  `details` blob NULL COMMENT '详情介绍',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '头像',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_by` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  ...
  `del_flag` tinyint(1) NULL DEFAULT 0 COMMENT '删除标识(0存在1删除)',
  `status` tinyint(1) NULL DEFAULT NULL COMMENT '状态(0可用，1不可用)',
  `flag` tinyint(1) NOT NULL DEFAULT 0 COMMENT '证件号是否可用（0可用，1不可用）',
  `audit` tinyint(1) NULL DEFAULT 0 COMMENT '审核标识(0未审核，1审核通过，2审核未通过)',
...
CREATE TABLE `teacher_user`  (
  `tu_id` int(0) NOT NULL AUTO_INCREMENT,
  `teacher_id` int(0) NULL DEFAULT NULL COMMENT '教员id',
  `user_id` int(0) NULL DEFAULT NULL COMMENT '用户id',
